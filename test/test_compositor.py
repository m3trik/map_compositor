...
class TestEnginePurity(unittest.TestCase):
    ...
    def test_no_qt_imports(self):
        import map_compositor.compositor as eng
...
class TestPublicApi(unittest.TestCase):
    """Legacy public symbols must still resolve from map_compositor."""

    def test_legacy_symbols_importable(self):
        import map_compositor as mc

        for name in ("MapCompositor", "MapCompositorSlots", "MapCompositorUI"):
            self.assertTrue(
